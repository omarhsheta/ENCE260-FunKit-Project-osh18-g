...
game.out: game.o pio.o system.o timer.o display.o ledmat.o navswitch.o ir_uart.o prescale.o font.o pacer.o tinygl.o timer0.o usart1.o game_init.o game_logic.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
